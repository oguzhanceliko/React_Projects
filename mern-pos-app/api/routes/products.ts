...
const getAllProductsRoute = async (req: express.Request, res: express.Response) => {
    try {
...
const updateProductRoute = async (req: express.Request, res: express.Response) => {
    try {
...
const DeleteProductRoute = async (req: express.Request, res: express.Response) => {
    try {
