        ...
        <div className="product-wrapper grid gap-4 grid-cols-card">
            <div className="product-item border hover:shadow-lg cursor-pointer transition-all select-none">
                <div className="product-img">
                    <img src="https://i.lezzet.com.tr/images-xxlarge-secondary/elma-nasil-yenir-221135ca-f383-474c-a4f5-ad02a45db978.jpg" alt="elma" className="h-28 object-cover w-full border-b" />
                </div>
